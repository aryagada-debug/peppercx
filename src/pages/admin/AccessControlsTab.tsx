...
const VIEW_OPTIONS: Record<string, string[]> = {
  ...
  "staffing":       ["All allocations", "Own pod allocations", "Own allocations only", "Capacity heatmap", "Hiring gaps"],
  ...
  "rgy-health":     ["Full RGY board", "Own pod RGY", "Own deals RGY", "Issue history", "AI summary"],
  "mbr-tracker":    ["All MBRs", "Own pod MBRs", "Own deals MBRs", "Notes & transcripts"],
...
const DEFAULT_SUMMARY: Record<AppRole, Partial<Record<string, { view: string[]; edit: string[] }>>> = {
  ...
  user: {
    "clients":     { view: ["Own deals only"],       edit: ["Edit own deals"] },
    "rgy-health":  { view: ["Own deals RGY"],        edit: ["Mark RGY (own deals)"] },
    "mbr-tracker": { view: ["Own deals MBRs"],       edit: ["Upload notes"] },
