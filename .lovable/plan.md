...
1. **Reconnect the central mailbox.** Needs one action from you in Settings → Notifications: "Set as central mailbox" while signed in as centralcx@peppercontent.io. Everything else stays blocked until this is done.
...
- **CC:** anirudh@peppercontent.io.
- **Content:** deal name and account, who locked it and when, plus a table of the full staffed team — name, role and allocation % — and a link to the deal.
...
- The global staffing suppression of anirudh@peppercontent.io stays for per-assignment emails but is bypassed for `staffing_locked`, since he is a required CC here.
